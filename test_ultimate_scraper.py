#!/usr/bin/env python3
"""
Test script untuk ultimate Radar Surabaya scraper
"""
...
from ultimate_radar_scraper import UltimateRadarSurabayaScraper
import json

def test_scraper():
    """Test fungsi scraper"""
    print("=== TEST ULTIMATE RADAR SURABAYA SCRAPER ===")
    
    scraper = UltimateRadarSurabayaScraper()
    ...
    try:
        ...
        if news_data:
            ...
            print(f"\n✅ Hasil test disimpan ke ultimate_test_results.json")
            return True
