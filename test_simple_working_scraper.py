#!/usr/bin/env python3
"""
Test script untuk simple working Radar Surabaya scraper
"""
...
from simple_working_scraper import SimpleWorkingRadarSurabayaScraper
import json

def test_scraper():
    """Test fungsi scraper"""
    print("=== TEST SIMPLE WORKING RADAR SURABAYA SCRAPER ===")
    ...
    try:
        ...
        if news_data:
            ...
            # Simpan hasil test
            with open('simple_working_test_results.json', 'w', encoding='utf-8') as f:
                json.dump(news_data, f, ensure_ascii=False, indent=2)
            
            print(f"\n✅ Hasil test disimpan ke simple_working_test_results.json")
            return True
