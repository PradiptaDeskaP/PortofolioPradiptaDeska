#!/usr/bin/env python3
"""
Test script untuk final working Radar Surabaya scraper
"""
...
from final_working_scraper import FinalWorkingRadarSurabayaScraper
import json

def test_scraper():
    """Test fungsi scraper"""
    print("=== TEST FINAL WORKING RADAR SURABAYA SCRAPER ===")
    ...
    try:
        ...
        if news_data:
            ...
            # Simpan hasil test
            with open('final_working_test_results.json', 'w', encoding='utf-8') as f:
                json.dump(news_data, f, ensure_ascii=False, indent=2)
            
            print(f"\n✅ Hasil test disimpan ke final_working_test_results.json")
            return True
