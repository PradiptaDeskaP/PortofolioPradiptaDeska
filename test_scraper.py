#!/usr/bin/env python3
"""
Test script untuk memverifikasi Radar Surabaya scraper
"""
...
from simple_radar_scraper import SimpleRadarSurabayaScraper
import json

def test_scraper():
    """Test fungsi scraper"""
    print("=== TEST RADAR SURABAYA SCRAPER ===")
    ...
    try:
        ...
        if news_data:
            ...
            print(f"\n✅ Hasil test disimpan ke test_results.json")
            return True
